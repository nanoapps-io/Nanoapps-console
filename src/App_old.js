...
class App_old extends Component {
  ...
  onDrop(acceptedFiles, rejectedFiles) {
    ...
    $.ajax({
      ...
      success: function (data) {
        this.setState({show_snackbar: true, message: 'Successfully uploaded the app', disable_publish_tab: false, app_file_location: data.file_path, fixedIndex: 1})
      }.bind(this),
  ...
  render() {
    ...
    return (
      <Layout>
        <NavDrawer active={this.state.drawerActive} pinned permanentAt='xxxl'>
          <section>
            <div className="logo"></div>
          </section>
          <section>
            <div className="below_logo"></div>
          </section>
          <section>
        ...
        <Panel>
          ...
          <div
            ...
            <div>
              <ProgressBar
                mode='determinate'
                className={progressbar_style}
                value={this.state.xhr_request_progress}/>
            </div>
                ...
                <section>
                  <form>
                    ...
                    <Input
                      ...
                      onChange={this
                      .handleChange
                      .bind(this, 'app_description')}/>
                    <Input
                      type="text"
                      required
                      value={this.state.main_component_name}
                      label="Index component"
                      name="main_component_name"
                      onChange={this
                      .handleChange
                      .bind(this, 'main_component_name')}/>
                    <Input
                      type="text"
                      required
                      value={this.state.app_icon_url}
                      label="App icon url"
                      name="app_icon_url"
                      onChange={this
                      .handleChange
                      .bind(this, 'app_icon_url')}/>
